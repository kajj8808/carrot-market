export default function Home() {
  return (
    <main className="flex items-center justify-center h-screen px-5 bg-gray-300">
      <div className="w-full p-5 bg-white shadow-md rounded-2xl">
        ...
        <div className="flex items-center gap-2 my-2">
          <span className="px-2.5 py-1.5 text-sm font-medium text-white uppercase bg-green-400 rounded-full">
            Today
          </span>
          <span>90:30-10:30</span>
        </div>
